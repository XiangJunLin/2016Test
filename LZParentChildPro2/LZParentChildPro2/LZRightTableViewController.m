...
@interface LZRightTableViewController ()

@end

@implementation LZRightTableViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:LZREUSEID forIndexPath:indexPath];
